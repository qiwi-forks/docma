...
class Template {
    ...
    constructor(params) {
        ...
        const author =
            typeof this._.pkg.author === "string"
                ? this._.pkg.author
    ...
    set defaultOptions(value) {
        ...
        this._.options = _.defaultsDeep(
            this._.options || this._.initialOptions,
            this.defaultOptions,
        );
    }
    ...
    get mainHTML() {
        return (
            this._.mainHTML || this._.pkg.docmaTemplate.mainHTML || "index.html"
        );
    }
    set mainHTML(value) {
     ...
     */
    get ignore() {
        return this._.ignore || this._.pkg.docmaTemplate.ignore || [];
    }
    set ignore(value) {
        this._.ignore = value;
    }
